...
<x-app-layout>
    ...
    <!--    />-->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col lg:flex-row gap-8">
            ...
            <main class="lg:w-3/4">
                <div class="relative w-full h-96 bg-cover bg-center rounded-xl shadow-md bg-[url('/public/{{ $page->image_url ? route('pages.image', basename($page->image_url)) : asset('public/images/placeholder.png') }}')]"
                    alt="{{ $page->title }}')">
                    <!-- Dark overlay -->
