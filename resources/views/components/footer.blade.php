<footer class="bg-bce-steel text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <div class="flex mt-2">
                        <input type="email" placeholder="Your email" class="px-4 py-2 w-full rounded-l-md text-gray-800">
                        <button class="bg-bce-accent hover:bg-orange-700 px-4 py-2 rounded-r-md">Subscribe</button>
                    </div>
                </div>
            </div>
            
            <div class="border-t border-gray-700 pt-8">
                <p class="text-gray-300 text-center">&copy; <?php echo date('Y'); ?> BCE Engineering. All rights reserved.</p>
            </div>
        </div>
    </footer>